        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 bg-white text-[#1a1a1a] text-sm font-semibold tracking-wider hover:bg-white/90 transition-all duration-300"
            >
              <img src="/meiman.svg" alt="Meiman" className="h-5 w-auto" />
              <span className="sm:hidden">Meiman.kg</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 bg-[#25D366] text-white text-sm font-semibold tracking-wider hover:bg-[#20ba5a] transition-all duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 border border-light/20 text-light/70 text-sm font-light tracking-wider hover:border-accent/50 hover:text-accent transition-all duration-300"
            >
